...
class TestPlayer(unittest.TestCase):
    ...
    def test_player_points_are_good(self):
        ...
        self.assertEqual(12, self.p1.calculate_points())
    ...
    def test_dealer_points_are_good(self):
        ...
        self.assertEqual(2, self.dealer.calculate_points())
        self.assertEqual(12, self.dealer.calculate_points(include_facedown=True))
